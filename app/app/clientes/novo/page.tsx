...
export default function NewClientWorkspacePage() {
  return (
    <DedicatedActionWorkspace
      ...
      primaryActionDescription="O novo cliente foi preparado em modo mockado."
      initialValues={{
        name: "Marina Costa",
      ...
      renderPreview={(values) => (
        <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
          <p className="text-[11px] uppercase tracking-[0.18em] text-primary/75">Cliente premium</p>
      ...
      sidebarInfo={{
        ...
        items: [
          ...
          { label: "Perfil", value: "Premium consultivo", hint: "Bom para catálogo e ofertas personalizadas." },
