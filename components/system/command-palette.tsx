...
const premiumShortcuts: Record<PortalKey, { id: string; label: string; href: string; icon: LucideIcon }[]> = {
  ...
  agency: [
    ...
    { id: "agency-nova-cotacao", label: "Nova cotação", href: "/app/viagens/cotacoes/nova", icon: FilePenLine },
    { id: "agency-novo-contrato", label: "Novo contrato", href: "/app/documentos/novo", icon: FilePenLine },
    { id: "agency-novo-lead", label: "Novo lead", href: "/app/leads/novo", icon: Waypoints },
